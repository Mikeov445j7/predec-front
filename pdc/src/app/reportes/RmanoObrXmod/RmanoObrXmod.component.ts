...
@Component({
  selector: 'app-RmanoObrXmod',
  templateUrl: 'RmanoObrXmod.component.html',
  styleUrls: ['RmanoObrXmod.component.scss']
})
export class RmanoObrXmodComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogo: MatDialogRef<RmanoObrXmodComponent>,
