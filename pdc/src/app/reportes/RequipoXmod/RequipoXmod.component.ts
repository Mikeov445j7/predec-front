...
@Component({
  selector: 'app-RequipoXmod',
  templateUrl: './RequipoXmod.component.html',
  styleUrls: ['./RequipoXmod.component.scss']
})
export class RequipoXmodComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogo: MatDialogRef<RequipoXmodComponent>,
  ...
  ngOnInit() {
    ...
    this.repServ.RequipoXmod(this.data).subscribe(r=>{
      this.reporte = r;
