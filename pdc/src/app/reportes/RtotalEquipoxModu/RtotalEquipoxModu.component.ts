...
@Component({
  selector: 'app-RtotalEquipoxModu',
  templateUrl: './RtotalEquipoxModu.component.html',
  styleUrls: ['./RtotalEquipoxModu.component.scss']
})
export class RtotalEquipoxModuComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogo: MatDialogRef<RtotalEquipoxModuComponent>,
