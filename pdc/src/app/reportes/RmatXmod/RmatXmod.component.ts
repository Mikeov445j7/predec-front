...
@Component({
  selector: 'app-RmatXmod',
  templateUrl: './RmatXmod.component.html',
  styleUrls: ['./RmatXmod.component.scss']
})
export class RmatXmodComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogo: MatDialogRef<RmatXmodComponent>,
  ...
  ngOnInit() {
    ...
    this.repServ.RmatXmod(this.data).subscribe(r=>{
      this.reporte = r;
